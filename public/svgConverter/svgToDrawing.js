function parseSVG(text, xOffset = 0, yOffset = 0, drawScale = 1) {
   ...
   //  const parser = new DOMParser();
    ...
    function parseRect(/*SVGRectElement*/rect) {
        ...
        const transform = rect.getScreenCTM().scale(drawScale, drawScale);
    ...
    function parsePath(path) {
        ...
        const transform = path.getScreenCTM().scale(drawScale, drawScale);
...
convertButton.onclick = (() => {
   ...
   const actions = parseSVG(svgInput.textContent);
